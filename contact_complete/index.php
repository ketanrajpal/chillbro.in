...
<!DOCTYPE HTML>
<html>
<?php head("Chillbro &bull; Contact us"); ?>
<body>
<?php top_header(); ?>
<?php slider("contact"); ?>
<section id="content">
 <h1>Thank You for contacting us. We will contact you in next 90mins.</h1>
 <p>Chillbro.in is a Complete shifting solution. which is not only providing Best in Class Service but  Also very Strict Regarding Time and Quality. We make sure anyone who uses our services for once will never go anywhere else for the same kind of service in future. So you just have make one call And all your Headache From Finding a Carpenter and Electrician For Uninstalling your valuable to Reinstalling it in a New Place is ours!</p><br><br>
</section>
